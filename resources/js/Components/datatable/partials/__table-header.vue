        ...
        <th v-for="(header, index) in columns"
            ...
            <div v-if="!header.checkbox" class="block">
                ...
                <div class="ml-1 inline-block" v-if="header.filter">
                    ...
                    <div class="filter-container p-3 border border-gray-200 bg-white rounded shadow-md" :class="header.filterPosition === 'left' ? 'filter-left' : ''" :id="`filter_column_${sanitize(header.name)}`">
