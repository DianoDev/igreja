<template>
    <div class="m-2" v-if="ready">
        <form @submit.prevent="submit">
            ...
            <div class="mb-4">
                <InputLabel for="descricao" value="Descricao" class="required"/>
                <TextInput
                    id="descricao"
                    class="w-full"
    ...
    axios.post(acao.value, form.value)
        ...
        .catch(error => {
            ...
            if (error.response) {
                ...
                const message = data.message || "Ocorreu um erro ao salvar  Estatuto.";
                handleError(message);
            } else {
...
function handleSuccess() {
    if(props.data?.id) {
        toast.success(" Estatuto editado com sucesso!");
    } else {
        toast.success(" Estatuto criado com sucesso!");
    }
    close();
}
