    ...
    <LayoutPublico>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div class="flex flex-wrap gap-4">
                <Link href="/publico/eventos" class="btn-primary">
                    Ver Todos os Eventos
                </Link>
                <Link href="/publico/sobre" class="btn-secondary">
                    Sobre Nós
                </Link>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <Link href="/publico/eventos" class="text-blue-600 hover:text-blue-700 font-medium">
                    Ver todos →
                </Link>
            </div>

            <div v-if="proximosEventos && proximosEventos.length > 0" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            ...
            <Link href="/publico/regimes-internos" class="card-link">
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
                    <div class="text-4xl mb-4">📋</div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Regimes Internos</h3>
            ...
            <Link href="/publico/estatutos" class="card-link">
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Estatutos</h3>
