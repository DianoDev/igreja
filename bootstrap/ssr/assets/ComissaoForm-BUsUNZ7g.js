...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))} data-v-7589ec4c><form data-v-7589ec4c><div class="space-y-4" data-v-7589ec4c><div data-v-7589ec4c>`);
      ...
      _push(`</div><div class="flex justify-center gap-3 pt-4" data-v-7589ec4c>`);
      if (!readOnly.value) {
        _push(`<button type="submit" class="px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:bg-blue-300"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""} data-v-7589ec4c><i class="mr-1 fa fa-save" data-v-7589ec4c></i> ${ssrInterpolate(processing.value ? "Salvando..." : "Salvar")}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button type="button" class="px-4 py-2 text-white bg-red-600 rounded-md hover:bg-red-700" data-v-7589ec4c><i class="mr-1 fa fa-close" data-v-7589ec4c></i> Cancelar </button></div></div></form></div>`);
    };
  }
};
...
const ComissaoForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7589ec4c"]]);
export {
