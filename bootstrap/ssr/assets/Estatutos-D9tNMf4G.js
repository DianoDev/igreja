    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(LayoutPublico, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-white rounded-lg shadow-lg p-6"${_scopeId}><h1 class="text-3xl font-bold text-gray-800 mb-6 flex items-center"${_scopeId}><span class="mr-3"${_scopeId}>⚖️</span> Estatuto </h1><p class="text-gray-600 mb-6"${_scopeId}> Consulte os estatutos oficiais da paróquia que definem sua organização, finalidades e funcionamento institucional. </p>`);
            if (__props.estatutos && __props.estatutos.length > 0) {
              ...
              ssrRenderList(__props.estatutos, (estatuto) => {
                ...
                _push2(`<div class="text-sm text-gray-500"${_scopeId}> Publicado em: ${ssrInterpolate(formatarDataHora(estatuto.created_at))}</div></div>`);
                if (estatuto.arquivo) {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.estatutos, (estatuto) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex justify-between items-start" }, [
                        ...
                        estatuto.arquivo ? (openBlock(), createBlock("button", {
                          key: 0,
                          onClick: ($event) => downloadArquivo(estatuto.arquivo),
