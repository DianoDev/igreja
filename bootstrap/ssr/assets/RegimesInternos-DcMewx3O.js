    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(LayoutPublico, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-white rounded-lg shadow-lg p-6"${_scopeId}><h1 class="text-3xl font-bold text-gray-800 mb-6 flex items-center"${_scopeId}><span class="mr-3"${_scopeId}>📋</span> Regimento Interno </h1><p class="text-gray-600 mb-6"${_scopeId}> Consulte os regimentos internos e normas que regem as atividades da paróquia e dos festeiros. </p>`);
