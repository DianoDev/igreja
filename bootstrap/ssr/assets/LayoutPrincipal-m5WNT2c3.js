...
const _sfc_main$3 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-4dde592a><div class="sidebar-layout" data-v-4dde592a><div class="sidebar-header" data-v-4dde592a><div class="logo-full" style="${ssrRenderStyle(!collapsed.value ? null : { display: "none" })}" data-v-4dde592a><a href="#" class="text-white" data-v-4dde592a> IGREJA </a></div><div class="logo-collapsed" style="${ssrRenderStyle(collapsed.value ? null : { display: "none" })}" data-v-4dde592a><a href="#" data-v-4dde592a></a></div></div><div class="sidebar-content" data-v-4dde592a><nav class="mt-5 menu" data-v-4dde592a><ul data-v-4dde592a><li class="${ssrRenderClass([{ "active": isActive("pessoas") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Dashboard" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-people-group" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Pessoas</span></a></li><li class="${ssrRenderClass([{ "active": isActive("cargo") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Cargo" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-pencil" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Cargo</span></a></li><li class="${ssrRenderClass([{ "active": isActive("cardapio") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Cardapio" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-utensils" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Cardápio</span></a></li><li class="${ssrRenderClass([{ "active": isActive("eventos") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Eventos" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-calendar" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Eventos</span></a></li><li class="${ssrRenderClass([{ "active": isActive("avisos") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "avisos" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-message" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Avisos</span></a></li><li class="${ssrRenderClass([{ "active": isActive("comissao") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Eventos" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-people-roof" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Comissão</span></a></li><li class="${ssrRenderClass([{ "active": isActive("regime-interno") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Regime Interno" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-file-contract" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Regimento Interno</span></a></li><li class="${ssrRenderClass([{ "active": isActive("estatuto") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Regime Interno" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-file-text" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Estatuto</span></a></li><li class="${ssrRenderClass([{ "active": isActive("atas") }, "menu-item"])}" data-v-4dde592a><a href="#" class="menu-link"${ssrRenderAttr("data-tooltip", collapsed.value ? "Regime Interno" : "")} data-v-4dde592a><span class="menu-icon" data-v-4dde592a><i class="fa fa-file-image" data-v-4dde592a></i></span><span class="menu-title" data-v-4dde592a>Ata</span></a></li></ul></nav></div><div class="sidebar-footer" data-v-4dde592a><div class="action-buttons" data-v-4dde592a></div></div></div></aside>`);
    };
  }
};
...
const SidebarMenu = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4dde592a"]]);
const _sfc_main$2 = {
  __name: "Popup",
  __ssrInlineRender: true,
  setup(__props) {
    const adminComponents = /* @__PURE__ */ Object.assign({ "../Pages/Admin/Ata/AtaForm.vue": () => import("./AtaForm-BVLfSOhL.js"), "../Pages/Admin/Ata/AtaIndex.vue": () => import("./AtaIndex-C8V2NNHo.js"), "../Pages/Admin/Avisos/AvisosForm.vue": () => import("./AvisosForm-DJchKqmU.js"), "../Pages/Admin/Avisos/AvisosIndex.vue": () => import("./AvisosIndex-DYAbNyAS.js"), "../Pages/Admin/Cardapio/CardapioForm.vue": () => import("./CardapioForm-BuB59Vzr.js"), "../Pages/Admin/Cardapio/CardapioIndex.vue": () => import("./CardapioIndex-CFqKO_C_.js"), "../Pages/Admin/Cardapio/Ingredientes.vue": () => import("./Ingredientes-B4XEw65J.js"), "../Pages/Admin/Cargo/CargoForm.vue": () => import("./CargoForm-iWacf1Z0.js"), "../Pages/Admin/Cargo/CargoIndex.vue": () => import("./CargoIndex-Ccdu71pe.js"), "../Pages/Admin/Comissao/ComissaoForm.vue": () => import("./ComissaoForm-BMO-2C49.js"), "../Pages/Admin/Comissao/ComissaoIndex.vue": () => import("./ComissaoIndex-C4s7EvSp.js"), "../Pages/Admin/Comissao/ComissaoInfo.vue": () => import("./ComissaoInfo-BR9Mjq3s.js"), "../Pages/Admin/Estatuto/EstatutoForm.vue": () => import("./EstatutoForm-CAgNm48n.js"), "../Pages/Admin/Estatuto/EstatutoIndex.vue": () => import("./EstatutoIndex-972gTmFk.js"), "../Pages/Admin/Eventos/EventoCardapioForm.vue": () => import("./EventoCardapioForm-67Po5Bkf.js"), "../Pages/Admin/Eventos/EventosForm.vue": () => import("./EventosForm-BDUgJpJr.js"), "../Pages/Admin/Eventos/EventosIndex.vue": () => import("./EventosIndex-CNDKiDus.js"), "../Pages/Admin/Eventos/EventosInfo.vue": () => import("./EventosInfo-TrEkTz0I.js"), "../Pages/Admin/Eventos/GaleriaEvento.vue": () => import("./GaleriaEvento-Blxom3Oa.js"), "../Pages/Admin/Pessoa/PessoaForm.vue": () => import("./PessoaForm-CGbuSKRK.js"), "../Pages/Admin/Pessoa/PessoaIndex.vue": () => import("./PessoaIndex-CsXT6KGm.js"), "../Pages/Admin/RegimeInterno/RegimeInternoForm.vue": () => import("./RegimeInternoForm-DWXRerh1.js"), "../Pages/Admin/RegimeInterno/RegimeInternoIndex.vue": () => import("./RegimeInternoIndex-B0oaCop_.js") });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (show.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          ...
          id: __props.id
        }, _attrs))} data-v-de148187><div class="flex items-center justify-center w-full min-h-screen px-4 text-center" data-v-de148187><div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" data-v-de148187></div><div class="relative inline-block overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:w-full sm:max-w-lg" data-v-de148187><div class="px-4 py-3 text-white bg-gray-800" data-v-de148187><div class="flex items-center justify-between" data-v-de148187><h3 class="text-lg font-medium" data-v-de148187>${ssrInterpolate(confirmation.value.title)}</h3><button type="button" class="text-gray-400 hover:text-white focus:outline-none" data-v-de148187><i class="fa fa-times" data-v-de148187></i></button></div></div><div class="px-4 py-5 bg-white" data-v-de148187><p data-v-de148187>${confirmation.value.message ?? ""}</p></div><div class="justify-end px-4 py-3 bg-gray-50 sm:flex sm:flex-row sm:px-6" data-v-de148187><button type="button" class="inline-flex items-center justify-center w-full px-3 py-2 text-sm font-medium text-white rounded-md shadow-sm bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:mr-3 sm:w-auto" data-v-de148187><i class="mr-2 fa fa-check" data-v-de148187></i> Confirmar </button><button type="button" class="inline-flex items-center justify-center w-full px-3 py-2 mt-3 text-sm font-medium text-white bg-gray-500 rounded-md shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 sm:mt-0 sm:w-auto" id="confirmation-cancel-button" data-v-de148187><i class="mr-2 fa fa-times" data-v-de148187></i> Cancelar </button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const ConfirmationPopup = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-de148187"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="main-content" data-v-80e6a3a1><header class="app-header" data-v-80e6a3a1><div class="header-container" data-v-80e6a3a1><div class="flex" data-v-80e6a3a1><button class="collapse-btn" data-v-80e6a3a1>`);
      if (!sidebarCollapsed.value) {
        _push(`<i class="fa fa-chevron-left" data-v-80e6a3a1></i>`);
      } else {
        _push(`<i class="fa fa-chevron-right" data-v-80e6a3a1></i>`);
      }
      _push(`</button><h1 class="page-title" data-v-80e6a3a1>${ssrInterpolate(pageTitle.value)}</h1></div></div></header><main class="content-wrapper" data-v-80e6a3a1><div class="main-slot-container" data-v-80e6a3a1>`);
      _push(ssrRenderComponent(ConfirmationPopup, null, null, _parent));
      _push(ssrRenderComponent(_sfc_main$2, null, null, _parent));
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></main></div><div class="${ssrRenderClass(["overlay", { "active": sidebarVisible.value }])}" data-v-80e6a3a1></div></div>`);
    };
  }
};
...
const LayoutPrincipal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-80e6a3a1"]]);
export {
