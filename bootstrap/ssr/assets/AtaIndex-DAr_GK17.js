...
const _sfc_main = {
  ...
  setup(__props) {
    useToast();
    inject("events");
    const source = ref("/admin/atas/list");
    const columns = ref([
        ...
        formatter: (val, row) => [
          {
            ...
            icon: "fa-edit",
            dataSize: "xl",
            dataComponent: "AtaForm",
            dataTitle: "Editar  Ata",
            dataJson: { id: row.id },
            text: "Editar"
          },
          {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="mr-2 fa fa-plus"${_scopeId2}></i> Novo Ata `);
                } else {
                  return [
                    createVNode("i", { class: "mr-2 fa fa-plus" }),
                    createTextVNode(" Novo Ata ")
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Ata/AtaIndex.vue");
