    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(LayoutPublico, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-white rounded-lg shadow-lg p-6"${_scopeId}><h1 class="text-3xl font-bold text-gray-800 mb-6 flex items-center"${_scopeId}><span class="mr-3"${_scopeId}>📋</span> Regime Interno </h1><p class="text-gray-600 mb-6"${_scopeId}> Consulte os regimentos internos e normas que regem as atividades da paróquia e dos festeiros. </p>`);
            if (__props.regimesInternos && __props.regimesInternos.length > 0) {
              ...
              ssrRenderList(__props.regimesInternos, (regime) => {
                ...
                _push2(`<div class="text-sm text-gray-500"${_scopeId}> Publicado em: ${ssrInterpolate(formatarDataHora(regime.created_at))}</div></div>`);
                if (regime.arquivo) {
            ...
            return [
              createVNode("div", { class: "bg-white rounded-lg shadow-lg p-6" }, [
                createVNode("h1", { class: "text-3xl font-bold text-gray-800 mb-6 flex items-center" }, [
                  ...
                  createTextVNode(" Regime Interno ")
                ]),
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.regimesInternos, (regime) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex justify-between items-start" }, [
                        ...
                        regime.arquivo ? (openBlock(), createBlock("button", {
                          key: 0,
                          onClick: ($event) => downloadArquivo(regime.arquivo),
