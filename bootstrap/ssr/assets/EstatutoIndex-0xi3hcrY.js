...
import "axios";
const _sfc_main = {
  __name: "EstatutoIndex",
  __ssrInlineRender: true,
  setup(__props) {
    useToast();
    inject("events");
    const source = ref("/admin/estatuto/list");
    const columns = ref([
        ...
        formatter: (val, row) => [
          {
            ...
            icon: "fa-edit",
            dataSize: "xl",
            dataComponent: "EstatutoForm",
            dataTitle: "Editar  Estatuto",
            dataJson: { id: row.id },
            text: "Editar"
          },
          {
            ...
            icon: "fa-trash",
            text: "Remover",
            deleteUrl: `/admin/estatuto/${row.id}`,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              title: "Novo  Estatuto",
              size: "xl",
              component: "EstatutoForm",
              variant: "secondary"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="mr-2 fa fa-plus"${_scopeId2}></i> Novo Estatuto `);
                } else {
                  return [
                    createVNode("i", { class: "mr-2 fa fa-plus" }),
                    createTextVNode(" Novo Estatuto ")
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Estatuto/EstatutoIndex.vue");
